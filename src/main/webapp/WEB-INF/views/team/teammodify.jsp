			...
			<div class="row">
				<div class="col-md-12">
					...
					<form role="form" id="teammodify" method="post">
						<input type="hidden" name="teamno"
							value="${teaminfoMap.teaminfo.teamno}"> <input
							type="text" name="teamname" id="teamname"
							value="${teaminfoMap.teaminfo.teamname}" placeholder="팀명">
						<input type="text" name="teamloc" id="teamloc"
							value="${teaminfoMap.teaminfo.teamloc}" placeholder="팀 활동지역">
						...
						<input type="submit" id="modifybtn" value="정보 수정"
							class="ListButton"> <input type="submit" id="cancelbtn"
							value="취소" class="ListButton">
					</form>
				</div>
				<!--// Full Section //-->
			</div>
...
<script>
	$(document).ready(function() {
		...
		var teamno = ${teaminfoMap.teaminfo.teamno};

		$.getJSON("/team/getAttach/" + teamno, function(list) {
			$(list).each(function() {
