			...
			<div class="row">
				<div class="col-md-12">
					...
					<form role="form" id="write" method="post">
						...
						<input type="hidden" name="postno" value="${boardVO.postno}">
						<input type="text" id="title" name="posttitle"
							value="${boardVO.posttitle}" placeholder="게시글 제목">
						<textarea id="content" name="postcontent"
							placeholder="일시,장소,상세 내용 등 자세히 적어 주세요">${boardVO.postcontent}</textarea>
						<div id="fileDrop">
							첨부 파일
						...
						<input type="submit" id="modifybtn" value="게시글 수정"
					...
					function() {
						...
						$("#cancelbtn")
								.on(
										"click",
										function() {
											self.location = "/freeboard/listPage?page=${cri.page}&perPageNum=${cri.perPageNum}&category={category}"
