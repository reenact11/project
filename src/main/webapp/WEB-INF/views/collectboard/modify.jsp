				...
				<div class="col-md-12">
					<form role="form" id="write" method="post">
						<input type="hidden" name="category"
							value="${collectDTO.category}"> <input type="hidden"
							name="postno" value="${collectDTO.postno}"> <input
							type="text" id="title" name="posttitle"
							value="${collectDTO.posttitle}" placeholder="게시글 제목">
						<textarea id="content" name="postcontent"
							placeholder="일시,장소,상세 내용 등 자세히 적어 주세요">${collectDTO.postcontent}</textarea>
