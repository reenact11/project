    ...
    vertical-align: middle !important;
            ...
            <div class="ritekhela-main-section ritekhela-fixture-list-full">
                <div class="container">
                    ...
                    <input type="hidden" name="userno" value="${TtoU.userno}">
                   	<input type="hidden" name="formno" value="${TtoU.formno}">
                	<select id="select" name="userbpm">
                    <option>평점</option>
                    <% for (int i = 40; i <= 140; i+=10) { %>
                    <option value="<%=i%>"><%=i%>bpm</option>
                     <% } %>
                    </select>
                    <textarea id="treview" name="ureview" placeholder="리뷰를 작성해 주세요"></textarea>
