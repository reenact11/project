    ...
    vertical-align: middle !important;
            ...
            <div class="ritekhela-main-section ritekhela-fixture-list-full">
                <div class="container">
                    ...
                    <div class="col-md-12">
                    <form action="${pageContext.request.contextPath}/matchboard/FromTReview.do" id="review" method="post">
                    ...
                    <textarea id="ureview" name="review" placeholder="리뷰를 작성해 주세요"></textarea>
